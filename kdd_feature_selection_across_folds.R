...
folds   = read.csv(file=paste0("./data/nsl-kdd/dat_batches/kdd_all_extended_", NUMOBS, "fobs_multiclass_folds_", NUMREPS, "x", NUMFOLDS, "cv.csv"), header=T, sep=",")
outfile.name = paste0("./data/nsl-kdd/dat_batches/kdd_all_extended_", NUMOBS, "fobs_multiclass_folds_selecvars_", NUMREPS, "x", NUMFOLDS, "cv.csv")
X = dataset[,1:134]
