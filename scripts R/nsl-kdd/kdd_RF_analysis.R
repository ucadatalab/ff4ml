...
OUTFILE = paste0(BASE.RESULTS.PATH, "kdd_RF_", NOBS, "_results.csv")
...
if (NOBS == 10000) {
        ...
        folds.kdd       = read.csv(file=paste0(WORKING.DIR, "data/nsl-kdd/dat_batches/output-KDD_all_extended_10000fobs_14bsize_multiclass_folds_20x5cv.csv"), header=T, sep=",", stringsAsFactors = F)
        varselected.kdd = read.csv(file=paste0(WORKING.DIR, "data/nsl-kdd/dat_batches/output-KDD_all_extended_10000fobs_14bsize_multiclass_folds_selecvars_20x5cv.csv"), header=T, sep=",", stringsAsFactors = F)
} else {
        ...
        folds.kdd       = read.csv(file=paste0(WORKING.DIR, "data/nsl-kdd/dat_batches/output-KDD_all_extended_20000fobs_7bsize_multiclass_folds_20x5cv.csv"), header=T, sep=",", stringsAsFactors = F)
        varselected.kdd = read.csv(file=paste0(WORKING.DIR, "data/nsl-kdd/dat_batches/output-KDD_all_extended_20000fobs_7bsize_multiclass_folds_selecvars_20x5cv.csv"), header=T, sep=",", stringsAsFactors = F)
}
