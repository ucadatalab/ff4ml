...
OUTFILE = paste0(BASE.RESULTS.PATH, "ugr16_RF_", NOBS, "_results.csv")

if (NOBS == 10000) {
        datos.ugr       = read.csv(file=paste0(WORKING.DIR, "data/ugr16/dat_batches/output-UGR16_all_extended_10000fobs_395082bsize_multiclass.csv"), header=T, sep=",", stringsAsFactors = F)
        folds.ugr       = read.csv(file=paste0(WORKING.DIR, "data/ugr16/dat_batches/output-UGR16_all_extended_10000fobs_395082bsize_multiclass_folds_20x5cv.csv"), header=T, sep=",", stringsAsFactors = F)
        varselected.ugr = read.csv(file=paste0(WORKING.DIR, "data/ugr16/dat_batches/output-UGR16_all_extended_10000fobs_395082bsize_multiclass_folds_selecvars_20x5cv.csv"), header=T, sep=",", stringsAsFactors = F)
} else {
        datos.ugr       = read.csv(file=paste0(WORKING.DIR, "data/ugr16/dat_batches/output-UGR16_all_extended_20000fobs_197541bsize_multiclass.csv"), header=T, sep=",", stringsAsFactors = F)
        folds.ugr       = read.csv(file=paste0(WORKING.DIR, "data/ugr16/dat_batches/output-UGR16_all_extended_20000fobs_197541bsize_multiclass_folds_20x5cv.csv"), header=T, sep=",", stringsAsFactors = F)
        varselected.ugr = read.csv(file=paste0(WORKING.DIR, "data/ugr16/dat_batches/output-UGR16_all_extended_20000fobs_197541bsize_multiclass_folds_selecvars_20x5cv.csv"), header=T, sep=",", stringsAsFactors = F)
}
