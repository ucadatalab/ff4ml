...
if (TYPE == "ts") {
        ...
        outfile.name = paste0("./data/ugr16/dat_", TYPE, "/ugr16_multiclass_selecvars_alldataset.csv")
        X = dataset[,2:135]
} else {
        dataset = read.csv(file=paste0("./data/ugr16/dat_", TYPE, "/ugr16_all_extended_", NUMOBS, "fobs_multiclass.csv"), header=T, sep=",")
        outfile.name = paste0("./data/ugr16/dat_", TYPE, "/ugr16_all_extended_", NUMOBS, "fobs_multiclass_selecvars_alldataset.csv")
        X = dataset[,1:134]
}
